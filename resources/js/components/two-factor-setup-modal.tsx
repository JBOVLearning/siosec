    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                ...
                description:
                    'La autenticación de dos factores está habilitada. Escanee el código QR o ingrese la clave en su aplicación autenticadora.',
                buttonText: 'Cerrar',
            };
        }
        ...
        return {
            ...
            description:
                'Para terminar de habilitar la autenticación de dos factores, escanee el código QR o ingrese la clave en su aplicación autenticadora',
            buttonText: 'Continuar',
        };
